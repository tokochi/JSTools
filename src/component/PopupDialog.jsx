...
export default function PopupDialog() {
  ...
  const { name, idIcon, idList, idSubList, icon, type, folder, path, clip, clipName, tooltip } = useStore((state) => state.selectedItem);
  ...
  return (
    <>
      {editType === "Add Icon" && dropdownOpen && (
      ...
      {editType === "Edit Icon" && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50  w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-2xl md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
      ...
      {editType === "Remove Icon" && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50 w-[300px] p-4 overflow-x-hidden overflow-y-auto">
      ...
      {editType === "Add Folder" && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50  w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-2xl md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
      ...
      {(editType === "Add ClipBoard" || editType === "Add Sub ClipBoard") && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50  w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-2xl md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
      ...
      {editType === "Edit Folder" && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50  w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-2xl md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
      ...
      {(editType === "Edit ClipBoard" || editType === "Edit Sub ClipBoard") && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50  w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-2xl md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
      ...
      {editType === "Remove Folder" && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50 w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-md md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <button
      ...
      {(editType === "Remove ClipBoard" || editType === "Remove Sub ClipBoard") && dropdownOpen && (
        <div className="fixed top-[100px] left-[100px] right-0 z-50 w-[300px] p-4 overflow-x-hidden overflow-y-auto">
          <div className="relative w-full h-full max-w-md md:h-auto">
            <div className="relative bg-[#111827] rounded-lg shadow">
              <button
